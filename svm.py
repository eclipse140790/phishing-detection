...
if __name__ == '__main__':
    print ("APT: Training a SVM to detect phishing websites")
	
    # Load the training data
    train_inputs, train_outputs, test_inputs, test_outputs = load_data()
    print ("Training data loaded.")

    # Create a SVM model using scikit-learn
    classifier = svm.SVC()
    print ("SVM created.")
    ...
    print ("The accuracy of your SVM classifier on testing data is: " + str(accuracy))
